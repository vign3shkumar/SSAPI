...
names = ['MARY', 'PATRICIA', 'LINDA', 'BARBARA', 'ELIZABETH', 'JENNIFER', 'MARIA', 'SUSAN', 'MARGARET', 'DOROTHY',
        ...
        'ARDELIA', 'ANNELLE', 'ANGILA', 'ALONA', 'ALLYN', 'JAMES', 'JOHN', 'ROBERT', 'MICHAEL', 'WILLIAM',
        ...
        'ERNEST', 'PHILLIP', 'TODD', 'JESSE', 'CRAIG', 'ALAN', 'SHAWN', 'CLARENCE', 'SEAN', 'PHILIP',
        ...
        'VINCENT', 'GLENN', 'JEFFERY', 'TRAVIS', 'JEFF', 'CHAD', 'JACOB', 'LEE', 'MELVIN', 'ALFRED',
        'KYLE', 'FRANCIS', 'BRADLEY', 'JESUS', 'HERBERT', 'FREDERICK', 'RAY', 'JOEL', 'EDWIN', 'DON',
        'EDDIE', 'RICKY', 'TROY', 'RANDALL', 'BARRY', 'ALEXANDER', 'BERNARD', 'MARIO', 'LEROY', 'FRANCISCO',
        'MARCUS', 'MICHEAL', 'THEODORE', 'CLIFFORD', 'MIGUEL', 'OSCAR', 'JAY', 'JIM', 'TOM', 'CALVIN',
        'ALEX', 'JON', 'RONNIE', 'BILL', 'LLOYD', 'TOMMY', 'LEON', 'DEREK', 'WARREN', 'DARRELL',
        ...
        'ROBERTO', 'CLYDE', 'GLEN', 'HECTOR', 'SHANE', 'RICARDO', 'SAM', 'RICK', 'LESTER', 'BRENT',
        ...
        'CODY', 'JULIO', 'KELLY', 'KURT', 'ALLAN', 'NELSON', 'GUY', 'CLAYTON', 'HUGH', 'MAX',
        'DWAYNE', 'DWIGHT', 'ARMANDO', 'FELIX', 'JIMMIE', 'EVERETT', 'JORDAN', 'IAN', 'WALLACE', 'KEN',
        'BOB', 'JAIME', 'CASEY', 'ALFREDO', 'ALBERTO', 'DAVE', 'IVAN', 'JOHNNIE', 'SIDNEY', 'BYRON',
        ...
        'EDUARDO', 'TERRENCE', 'ENRIQUE', 'FREDDIE', 'WADE', 'AUSTIN', 'STUART', 'FREDRICK', 'ARTURO', 'ALEJANDRO',
        'JACKIE', 'JOEY', 'NICK', 'LUTHER', 'WENDELL', 'JEREMIAH', 'EVAN', 'JULIUS', 'DANA', 'DONNIE',
        'OTIS', 'SHANNON', 'TREVOR', 'OLIVER', 'LUKE', 'HOMER', 'GERARD', 'DOUG', 'KENNY', 'HUBERT',
        'ANGELO', 'SHAUN', 'LYLE', 'MATT', 'LYNN', 'ALFONSO', 'ORLANDO', 'REX', 'CARLTON', 'ERNESTO',
        ...
        'SYLVESTER', 'KIM', 'ROOSEVELT', 'ISRAEL', 'JERMAINE', 'FORREST', 'WILBERT', 'LELAND', 'SIMON', 'GUADALUPE',
        ...
        'CLINT', 'NICOLAS', 'LAURENCE', 'ISMAEL', 'ORVILLE', 'DREW', 'JODY', 'ERVIN', 'DEWEY', 'AL',
        'WILFRED', 'JOSH', 'HUGO', 'IGNACIO', 'CALEB', 'TOMAS', 'SHELDON', 'ERICK', 'FRANKIE', 'STEWART',
        'DOYLE', 'DARREL', 'ROGELIO', 'TERENCE', 'SANTIAGO', 'ALONZO', 'ELIAS', 'BERT', 'ELBERT', 'RAMIRO',
        'CONRAD', 'PAT', 'NOAH', 'GRADY', 'PHIL', 'CORNELIUS', 'LAMAR', 'ROLANDO', 'CLAY', 'PERCY',
        ...
        'LAMONT', 'STACY', 'GARLAND', 'MILES', 'MICAH', 'EFRAIN', 'BILLIE', 'LOGAN', 'HEATH', 'RODGER',
        'HARLEY', 'DEMETRIUS', 'ETHAN', 'ELDON', 'ROCKY', 'PIERRE', 'JUNIOR', 'FREDDY', 'ELI', 'BRYCE',
        'ANTOINE', 'ROBBIE', 'KENDALL', 'ROYCE', 'STERLING', 'MICKEY', 'CHASE', 'GROVER', 'ELTON', 'CLEVELAND',
        'DYLAN', 'CHUCK', 'DAMIAN', 'REUBEN', 'STAN', 'AUGUST', 'LEONARDO', 'JASPER', 'RUSSEL', 'ERWIN',
        'BENITO', 'HANS', 'MONTE', 'BLAINE', 'ERNIE', 'CURT', 'QUENTIN', 'AGUSTIN', 'MURRAY', 'JAMAL',
        'DEVON', 'ADOLFO', 'HARRISON', 'TYSON', 'BURTON', 'BRADY', 'ELLIOTT', 'WILFREDO', 'BART', 'JARROD',
        'VANCE', 'DENIS', 'DAMIEN', 'JOAQUIN', 'HARLAN', 'DESMOND', 'ELLIOT', 'DARWIN', 'ASHLEY', 'GREGORIO',
        ...
        'EDDY', 'SEBASTIAN', 'FEDERICO', 'ULYSSES', 'HERIBERTO', 'DONNELL', 'COLE', 'DENNY', 'DAVIS', 'GAVIN',
        'EMERY', 'WARD', 'ROMEO', 'JAYSON', 'DION', 'DANTE', 'CLEMENT', 'COY', 'ODELL', 'MAXWELL',
        ...
        'MARIANO', 'DANIAL', 'BLAIR', 'LANDON', 'DIRK', 'BRANDEN', 'ADAN', 'NUMBERS', 'CLAIR', 'BUFORD',
        'GERMAN', 'BERNIE', 'WILMER', 'JOAN', 'EMERSON', 'ZACHERY', 'FLETCHER', 'JACQUES', 'ERROL', 'DALTON',
        'MONROE', 'JOSUE', 'DOMINIQUE', 'EDWARDO', 'BOOKER', 'WILFORD', 'SONNY', 'SHELTON', 'CARSON', 'THERON',
        'RAYMUNDO', 'DAREN', 'TRISTAN', 'HOUSTON', 'ROBBY', 'LINCOLN', 'JAME', 'GENARO', 'GALE', 'BENNETT',
        'OCTAVIO', 'CORNELL', 'LAVERNE', 'HUNG', 'ARRON', 'ANTONY', 'HERSCHEL', 'ALVA', 'GIOVANNI', 'GARTH',
        'CYRUS', 'CYRIL', 'RONNY', 'STEVIE', 'LON', 'FREEMAN', 'ERIN', 'DUNCAN', 'KENNITH', 'CARMINE',
        'AUGUSTINE', 'YOUNG', 'ERICH', 'CHADWICK', 'WILBURN', 'RUSS', 'REID', 'MYLES', 'ANDERSON', 'MORTON',
        'JONAS', 'FOREST', 'MITCHEL', 'MERVIN', 'ZANE', 'RICH', 'JAMEL', 'LAZARO', 'ALPHONSE', 'RANDELL',
        'MAJOR', 'JOHNIE', 'JARRETT', 'BROOKS', 'ARIEL', 'ABDUL', 'DUSTY', 'LUCIANO', 'LINDSEY', 'TRACEY',
        'SEYMOUR', 'SCOTTIE', 'EUGENIO', 'MOHAMMED', 'SANDY', 'VALENTIN', 'CHANCE', 'ARNULFO', 'LUCIEN', 'FERDINAND',
        'THAD', 'EZRA', 'SYDNEY', 'ALDO', 'RUBIN', 'ROYAL', 'MITCH', 'EARLE', 'ABE', 'WYATT',
        'MARQUIS', 'LANNY', 'KAREEM', 'JAMAR', 'BORIS', 'ISIAH', 'EMILE', 'ELMO', 'ARON', 'LEOPOLDO',
        'EVERETTE', 'JOSEF', 'GAIL', 'ELOY', 'DORIAN', 'RODRICK', 'REINALDO', 'LUCIO', 'JERROD', 'WESTON',
        'HERSHEL', 'BARTON', 'PARKER', 'LEMUEL', 'LAVERN', 'BURT', 'JULES', 'GIL', 'ELISEO', 'AHMAD',
        'NIGEL', 'EFREN', 'ANTWAN', 'ALDEN', 'MARGARITO', 'COLEMAN', 'REFUGIO', 'DINO', 'OSVALDO', 'LES',
        'DEANDRE', 'NORMAND', 'KIETH', 'IVORY', 'ANDREA', 'TREY', 'NORBERTO', 'NAPOLEON', 'JEROLD', 'FRITZ',
        'ROSENDO', 'MILFORD', 'SANG', 'DEON', 'CHRISTOPER', 'ALFONZO', 'LYMAN', 'JOSIAH', 'BRANT', 'WILTON',
        'RICO', 'JAMAAL', 'DEWITT', 'CAROL', 'BRENTON', 'YONG', 'OLIN', 'FOSTER', 'FAUSTINO', 'CLAUDIO',
        'JUDSON', 'GINO', 'EDGARDO', 'BERRY', 'ALEC', 'TANNER', 'JARRED', 'DONN', 'TRINIDAD', 'TAD',
        'SHIRLEY', 'PRINCE', 'PORFIRIO', 'ODIS', 'MARIA', 'LENARD', 'CHAUNCEY', 'CHANG', 'TOD', 'MEL',
        'MARCELO', 'KORY', 'AUGUSTUS', 'KEVEN', 'HILARIO', 'BUD', 'SAL', 'ROSARIO', 'ORVAL', 'MAURO',
        'DANNIE', 'ZACHARIAH', 'OLEN', 'ANIBAL', 'MILO', 'JED', 'FRANCES', 'THANH', 'DILLON', 'AMADO',
        'NEWTON', 'CONNIE', 'LENNY', 'TORY', 'RICHIE', 'LUPE', 'HORACIO', 'BRICE', 'MOHAMED', 'DELMER',
        'DARIO', 'REYES', 'DEE', 'MAC', 'JONAH', 'JERROLD', 'ROBT', 'HANK', 'SUNG', 'RUPERT',
        'ROLLAND', 'KENTON', 'DAMION', 'CHI', 'ANTONE', 'WALDO', 'FREDRIC', 'BRADLY', 'QUINN', 'KIP',
        'BURL', 'WALKER', 'TYREE', 'JEFFEREY', 'AHMED', 'WILLY', 'STANFORD', 'OREN', 'NOBLE', 'MOSHE',
         'MIKEL', 'ENOCH', 'BRENDON', 'QUINTIN', 'JAMISON', 'FLORENCIO', 'DARRICK', 'TOBIAS', 'MINH', 'HASSAN',
         ...
         'ISAIAS', 'HIPOLITO', 'FERMIN', 'CHUNG', 'ADALBERTO', 'VALENTINE', 'JAMEY', 'BO', 'BARRETT', 'WHITNEY',
         'TEODORO', 'MCKINLEY', 'MAXIMO', 'GARFIELD', 'SOL', 'RALEIGH', 'LAWERENCE', 'ABRAM', 'RASHAD', 'KING',
         'EMMITT', 'DARON', 'CHONG', 'SAMUAL', 'PARIS', 'OTHA', 'MIQUEL', 'LACY', 'EUSEBIO', 'DONG',
         'DOMENIC', 'DARRON', 'BUSTER', 'ANTONIA', 'WILBER', 'RENATO', 'JC', 'HOYT', 'HAYWOOD', 'EZEKIEL',
         'CHAS', 'FLORENTINO', 'ELROY', 'CLEMENTE', 'ARDEN', 'NEVILLE', 'KELLEY', 'EDISON', 'DESHAWN', 'CARROL',
         'SHAYNE', 'NATHANIAL', 'JORDON', 'DANILO', 'CLAUD', 'VAL', 'SHERWOOD', 'RAYMON', 'RAYFORD', 'CRISTOBAL',
         'AMBROSE', 'TITUS', 'HYMAN', 'FELTON', 'EZEQUIEL', 'ERASMO', 'STANTON', 'LONNY', 'LEN', 'IKE',
         'MILAN', 'LINO', 'JAROD', 'HERB', 'ANDREAS', 'WALTON', 'RHETT', 'PALMER', 'JUDE', 'DOUGLASS',
         'CORDELL', 'OSWALDO', 'ELLSWORTH', 'VIRGILIO', 'TONEY', 'NATHANAEL', 'DEL', 'BRITT', 'BENEDICT', 'MOSE',
         'HONG', 'LEIGH', 'JOHNSON', 'ISREAL', 'GAYLE', 'GARRET', 'FAUSTO', 'ASA', 'ARLEN', 'ZACK',
         'WARNER', 'MODESTO', 'FRANCESCO', 'MANUAL', 'JAE', 'GAYLORD', 'GASTON', 'FILIBERTO', 'DEANGELO', 'MICHALE',
         'GRANVILLE', 'WES', 'MALIK', 'ZACKARY', 'TUAN', 'NICKY', 'ELDRIDGE', 'CRISTOPHER', 'CORTEZ', 'ANTIONE',
         'MALCOM', 'LONG', 'KOREY', 'JOSPEH', 'COLTON', 'WAYLON', 'VON', 'HOSEA', 'SHAD', 'SANTO',
         'RUDOLF', 'ROLF', 'REY', 'RENALDO', 'MARCELLUS', 'LUCIUS', 'LESLEY', 'KRISTOFER', 'BOYCE', 'BENTON',
         'MAN', 'KASEY', 'JEWELL', 'HAYDEN', 'HARLAND', 'ARNOLDO', 'RUEBEN', 'LEANDRO', 'KRAIG', 'JERRELL',
         'JEROMY', 'HOBERT', 'CEDRICK', 'ARLIE', 'WINFORD', 'WALLY', 'PATRICIA', 'LUIGI', 'KENETH', 'JACINTO',
         'GRAIG', 'FRANKLYN', 'EDMUNDO', 'SID', 'PORTER', 'LEIF', 'LAUREN', 'JERAMY', 'ELISHA', 'BUCK',
         'WILLIAN', 'VINCENZO', 'SHON', 'MICHAL', 'LYNWOOD', 'LINDSAY', 'JEWEL', 'JERE', 'HAI', 'ELDEN',
         'DORSEY', 'DARELL', 'BRODERICK', 'ALONSO']

signers=["Test Microsoft Corporation",
         "Test Adobe Inc",
         "Test Microsoft Windows",
         "Test Sun Microsystems",
         "Test Microsoft Publisher",
         "Test Mozilla Foundation",
         "Test Google Inc",
         "Test K7 Computing Pvt Ltd",
         "Test Python Foundation",
         ""]

paths=["C:\\program files\\adobe\\",
...
winsxs=["amd64_1394.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_5380d7967a090394",
        "amd64_1394.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_82511fcd374f02f4",
        "amd64_3ware.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_36489edc430074fd",
        "amd64_3ware.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_6518e7130046745d",
        "amd64_61883.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_26c315f905befea5",
        "amd64_61883.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_55935e2fc304fe05",
        "amd64_acpi.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_a478c8af210e70ca",
        "amd64_acpi.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_d34910e5de54702a",
        "amd64_acpidev.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_dbeb6c2bd8dc5619",
        "amd64_acpidev.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_0abbb46296225579",
        "amd64_acpipagr.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_bcc22e4cffbde63e",
        "amd64_acpipagr.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_eb927683bd03e59e",
        "amd64_acpipmi.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_4144ab043aadd46a",
        "amd64_acpipmi.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_7014f33af7f3d3ca",
        "amd64_acpitime.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_3bc206125a7ae97f",
        "amd64_acpitime.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_6a924e4917c0e8df",
        "amd64_adaptivecards-xamlcardrenderer_31bf3856ad364e35_10.0.17763.1_none_cb99e5f87681efc0",
        "amd64_addinprocess32_b77a5c561934e089_10.0.17763.1_none_71d59a2245104fdd",
        "amd64_addinprocess32_b77a5c561934e089_4.0.15713.0_none_f9062051c9ed7bf1",
        "amd64_addinprocess32_b77a5c561934e089_4.0.15744.161_none_efbbb66e6d175e31",
        "amd64_adobe-flash-for-windows_31bf3856ad364e35_10.0.17763.1_none_1c65cdebc1b8ffc5",
        "amd64_adobe-flash-for-windows_31bf3856ad364e35_10.0.17763.500_none_a08eb2f2ef1d8ad3",
        "amd64_adobe-flash-for-windows_31bf3856ad364e35_10.0.17763.827_none_a0801ad2ef276b8b",
        "amd64_adp80xx.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_1a5af153c2cd2b1e",
        "amd64_adp80xx.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_492b398a80132a7e",
        "amd64_amdsata.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_30f2d292a3d81092",
        "amd64_amdsata.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_5fc31ac9611e0ff2",
        "amd64_amdsbs.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_bb4da6febd99a041",
        "amd64_amdsbs.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_ea1def357adf9fa1",
        "amd64_arcsas.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_43509f550e493f74",
        "amd64_arcsas.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_7220e78bcb8f3ed4",
        "amd64_aspnet_compiler_b03f5f7f11d50a3a_10.0.17763.1_none_8d3b2a18dcfe038b",
        "amd64_aspnet_compiler_b03f5f7f11d50a3a_4.0.15713.0_none_71e412ec46959160",
        "amd64_aspnet_compiler_b03f5f7f11d50a3a_4.0.15744.161_none_6899a908e9bf73a0",
        "amd64_aspnet_regbrowsers_b03f5f7f11d50a3a_10.0.17763.1_none_7ddc12219d7fda51",
        "amd64_aspnet_regbrowsers_b03f5f7f11d50a3a_4.0.15713.0_none_6284faf507176826",
        "amd64_aspnet_regbrowsers_b03f5f7f11d50a3a_4.0.15744.161_none_593a9111aa414a66",
        "amd64_aspnet_regsql_b03f5f7f11d50a3a_10.0.17763.1_none_c44e23a840a19362",
        "amd64_aspnet_regsql_b03f5f7f11d50a3a_4.0.15713.0_none_a8f70c7baa392137",
        "amd64_aspnet_regsql_b03f5f7f11d50a3a_4.0.15744.161_none_9faca2984d630377",
        "amd64_athw8x.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_f631db7bf57228d9",
        "amd64_athw8x.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_250223b2b2b82839",
        "amd64_audioendpoint.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_11f122d07a53941c",
        "amd64_audioendpoint.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_40c16b073799937c",
        "amd64_auditpolicygpmanagedstubs.interop_31bf3856ad364e35_10.0.17763.1_none_12bb1dfec19d8dc",
        "amd64_avc.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_04de8e7c21c9244f",
        "amd64_avc.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_33aed6b2df0f23af",
        "amd64_backupwmbclass.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_191143dd26f27617",
        "amd64_backupwmbclass.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_47e18c13e4387577",
        "amd64_basicdisplay.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_29f541cd29d29dad",
        "amd64_basicdisplay.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_58c58a03e7189d0d",
        "amd64_basicrender.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_7d59af99183d9f25",
        "amd64_basicrender.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_ac29f7cfd5839e85",
        "amd64_battery.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_55b7a69b921de49e",
        "amd64_battery.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_8487eed24f63e3fe",
        "amd64_bcmfn2.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_121c45dac6ad0645",
        "amd64_bcmwdidhdpcie.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_a9c95c512cc28522",
        "amd64_bcmwdidhdpcie.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_d899a487ea088482",
        "amd64_bda.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_253b3c3d27509bf0",
        "amd64_bsdtar_31bf3856ad364e35_10.0.17763.1_none_46f3f626c42a44ef",
        "amd64_bth-cpl.resources_31bf3856ad364e35_10.0.17763.1_en-us_aea891720a70cafa",
        "amd64_bth-cpl.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_dd78d9a8c7b6ca5a",
        "amd64_bth-user.resources_31bf3856ad364e35_10.0.17763.1_en-us_578060b7d116fc7c",
        "amd64_bth-user.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_8650a8ee8e5cfbdc",
        "amd64_bth.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_49519b75d1e04529",
        "amd64_bth.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_7821e3ac8f264489",
        "amd64_bth.inf.resources_31bf3856ad364e35_10.0.17763.678_en-us_cd36d53eff765bad",
        "amd64_bth.inf.resources_31bf3856ad364e35_10.0.17763.678_ja-jp_fc071d75bcbc5b0d",
        "amd64_bthleenum.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_6d0f2c81367bfe5f",
        "amd64_bthleenum.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_9bdf74b7f3c1fdbf",
        "amd64_bthmtpenum.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_a9ee3178b7de183d",
        "amd64_bthmtpenum.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_d8be79af7524179d",
        "amd64_bthpan.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_4e854fcf58f2acd6",
        "amd64_bthpan.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_7d5598061638ac36",
        "amd64_bthprint.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_28b0d218fcc90714",
        "amd64_bthprint.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_57811a4fba0f0674",
        "amd64_bthspp.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_8906b669344523be",
        "amd64_bthspp.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_b7d6fe9ff18b231e",
        "amd64_buttonconverter.inf.resources_31bf3856ad364e35_10.0.17763.1_en-us_34a9e7fc7f94704b",
        "amd64_buttonconverter.inf.resources_31bf3856ad364e35_10.0.17763.1_ja-jp_637a30333cda6fab"]
